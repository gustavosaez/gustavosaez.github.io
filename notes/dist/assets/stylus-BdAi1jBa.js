...
function p(i) {
  for (var e = {}, r = 0; r < i.length; ++r) e[i[r]] = true;
  return e;
}
function H(i) {
...
function fe(i, e) {
  if (q = i.string.match(/(^[\w-]+\s*=\s*$)|(^\s*[\w-]+\s*=\s*[\w-])|(^\s*(\.|#|@|\$|\&|\[|\d|\+|::?|\{|\>|~|\/)?\s*[\w-]*([a-z0-9-]|\*|\/\*)(\(|,)?)/), e.context.line.firstWord = q ? q[0].replace(/^\s*/, "") : "", e.context.line.indent = i.indentation(), g = i.peek(), i.match("//")) return i.skipToEnd(), ["comment", "comment"];
...
function Y(i) {
  return function(e, r) {
    for (var o = false, l; (l = e.next()) != null; ) {
      if (l == i && !o) {
        i == ")" && e.backUp(1);
        break;
      }
...
function pe(i, e) {
  return i.next(), i.match(/\s*[\"\')]/, false) ? e.tokenize = null : e.tokenize = Y(")"), [null, "("];
}
function Z(i, e, r, o) {
...
function v(i, e, r) {
  ...
  return r = r || false, i.context = i.context.prev, r && (i.context.indent = o), i.context.type;
}
function he(i, e, r) {
...
function D(i, e) {
  return i == "{" && e.match(/^\s*\$?[\w-]+/i, false);
}
function M(i, e) {
  return i == ":" && e.match(/^[a-z-]+/, false);
}
function k(i) {
  return i.sol() || i.string.match(new RegExp("^\\s*" + H(i.current())));
}
function a(i) {
  return i.eol() || i.match(/^\s*$/, false);
}
function u(i) {
...
c.block = function(i, e, r) {
  ...
  if (i == "variable-name") return e.string.match(/^\s?\$[\w-\.\[\]\'\"]+$/) || w(u(e)) ? n(r, e, "variableName") : n(r, e, "variableName", 0);
  if (i == "=") return !a(e) && !w(u(e)) ? n(r, e, "block", 0) : n(r, e, "block");
  if (i == "*" && (a(e) || e.match(/\s*(,|\.|#|\[|:|{)/, false))) return t = "tag", n(r, e, "block");
  ...
  if (i && i.charAt(0) == "@") return e.indentation() > 0 && x(e.current().slice(1)) ? (t = "variable", "block") : /(@import|@require|@charset)/.test(i) ? n(r, e, "block", 0) : n(r, e, "block");
  ...
  if (i == "word") {
    ...
    if (t == "tag") {
      if (/embed|menu|pre|progress|sub|table/.test(o) && x(u(e)) || e.string.match(new RegExp("\\[\\s*" + o + "|" + o + "\\s*\\]"))) return t = "atom", "block";
      if (j.test(o) && (k(e) && e.string.match(/=/) || !k(e) && !e.string.match(/^(\s*\.|#|\&|\[|\/|>|\*)/) && !b(u(e)))) return t = "variable", w(u(e)) ? "block" : n(r, e, "block", 0);
...
c.parens = function(i, e, r) {
  if (i == "(") return n(r, e, "parens");
  if (i == ")") return r.context.prev.type == "parens" ? v(r, e) : e.string.match(/^[a-z][\w-]*\(/i) && a(e) || w(u(e)) || /(\.|#|:|\[|\*|&|>|~|\+|\/)/.test(u(e)) || !e.string.match(/^-?[a-z][\w-\.\[\]\'\"]*\s*=/) && b(u(e)) ? n(r, e, "block") : e.string.match(/^[\$-]?[a-z][\w-\.\[\]\'\"]*\s*=/) || e.string.match(/^\s*(\(|\)|[0-9])/) || e.string.match(/^\s+[a-z][\w-]*\(/i) || e.string.match(/^\s+[\$-]?[a-z]/i) ? n(r, e, "block", 0) : a(e) ? n(r, e, "block") : n(r, e, "block", 0);
...
c.atBlock = function(i, e, r) {
  ...
  if (i == "word") {
    ...
    if (/^(only|not|and|or)$/.test(o) ? t = "keyword" : ne.hasOwnProperty(o) ? t = "tag" : ae.hasOwnProperty(o) ? t = "attribute" : te.hasOwnProperty(o) ? t = "property" : ee.hasOwnProperty(o) ? t = "string.special" : t = y(e.current()), t == "tag" && a(e)) return n(r, e, "block");
  }
...
const ge = { name: "stylus", startState: function() {
