...
var N = s(["and", "or", "not", "is"]), E = ["as", "assert", "break", "class", "continue", "def", "del", "elif", "else", "except", "finally", "for", "from", "global", "if", "import", "lambda", "pass", "raise", "return", "try", "while", "with", "yield", "in", "False", "True"], F = ["abs", "all", "any", "bin", "bool", "bytearray", "callable", "chr", "classmethod", "compile", "complex", "delattr", "dict", "dir", "divmod", "enumerate", "eval", "filter", "float", "format", "frozenset", "getattr", "globals", "hasattr", "hash", "help", "hex", "id", "input", "int", "isinstance", "issubclass", "iter", "len", "list", "locals", "map", "max", "memoryview", "min", "next", "object", "oct", "open", "ord", "pow", "property", "range", "repr", "reversed", "round", "set", "setattr", "slice", "sorted", "staticmethod", "str", "sum", "super", "tuple", "type", "vars", "zip", "__import__", "NotImplemented", "Ellipsis", "__debug__"];
function c(o) {
  return o.scopes[o.scopes.length - 1];
}
function A(o) {
  for (var p = "error", O = o.delimiters || o.singleDelimiters || /^[\(\)\[\]\{\}@,:`=;\.\\]/, h = [o.singleOperators, o.doubleOperators, o.doubleDelimiters, o.tripleDelimiters, o.operators || /^([-+*/%\/&|^]=?|[<>=]+|\/\/=?|\*\*=?|!=|[~!@]|\.\.\.)/], g = 0; g < h.length; g++) h[g] || h.splice(g--, 1);
  ...
  if (x) {
    ...
    var y = o.identifiers || /^[_A-Za-z][_A-Za-z0-9]*/;
    d = d.concat(["exec", "print"]), a = a.concat(["apply", "basestring", "buffer", "cmp", "coerce", "execfile", "file", "intern", "long", "raw_input", "reduce", "reload", "unichr", "unicode", "xrange", "None"]);
  ...
  function v(n, e, r) {
    ...
    if (n.match(/^[0-9\.]/, false)) {
      var i = false;
      if (n.match(/^[\d_]*\.\d+(e[\+\-]?\d+)?/i) && (i = true), n.match(/^[\d_]+\.\d*/) && (i = true), n.match(/^\.\d+/) && (i = true), i) return n.eat(/J/i), "number";
      var l = false;
      if (n.match(/^0x[0-9a-f_]+/i) && (l = true), n.match(/^0b[01_]+/i) && (l = true), n.match(/^0o[0-7_]+/i) && (l = true), n.match(/^[1-9][\d_]*(e[\+\-]?[\d_]+)?/) && (n.eat(/J/i), l = true), n.match(/^0(?![\dx])/i) && (l = true), l) return n.eat(/L/i), "number";
    }
    if (n.match(w)) {
  ...
  function R(n, e) {
    ...
    function t(u, f) {
      for (; !u.eol(); ) if (u.eatWhile(/[^'"\{\}\\]/), u.eat("\\")) {
        if (u.next(), r && u.eol()) return i;
      } else {
        if (u.match(n)) return f.tokenize = e, i;
        if (u.match("{{")) return i;
        if (u.match("{", false)) return f.tokenize = l(0), u.current() ? i : f.tokenize(u, f);
        if (u.match("}}")) return i;
        if (u.match("}")) return p;
        u.eat(/['"]/);
      }
  ...
  function D(n, e) {
    ...
    if (e.beginningOfLine && i == "@") return n.match(y, false) ? "meta" : x ? "operator" : p;
    if (/\S/.test(i) && (e.beginningOfLine = false), (r == "variable" || r == "builtin") && e.lastToken == "meta" && (r = "meta"), (i == "pass" || i == "return") && (e.dedent = true), i == "lambda" && (e.lambda = true), i == ":" && !e.lambda && c(e).type == "py" && n.match(/^\s*(?:#|$)/, false) && S(n, e), i.length == 1 && !/string|comment/.test(r)) {
      var l = "[({".indexOf(i);
      if (l != -1 && m(n, e, "])}".slice(l, l + 1)), l = "])}".indexOf(i), l != -1) if (c(e).type == i) e.indent = e.scopes.pop().offset - (k || n.indentUnit);
      else return p;
    }
    return e.dedent && n.eol() && c(e).type == "py" && e.scopes.length > 1 && e.scopes.pop(), r;
  }
  return { name: "python", startState: function() {
    return { tokenize: z, scopes: [{ offset: 0, type: "py", align: null }], indent: 0, lastToken: null, lambda: false, dedent: 0 };
  }, token: function(n, e) {
    var r = e.errorToken;
  ...
  }, languageData: { autocomplete: E.concat(F).concat(["exec", "print"]), indentOnInput: /^\s*([\}\]\)]|else:|elif |except |finally:)$/, commentTokens: { line: "#" }, closeBrackets: { brackets: ["(", "[", "{", "'", '"', "'''", '"""'] } } };
}
var U = function(o) {
  return o.split(" ");
};
const Z = A({}), P = A({ extra_keywords: U("by cdef cimport cpdef ctypedef enum except extern gil include nogil property public readonly struct union DEF IF ELIF ELSE") });
export {
  P as cython,
  A as mkPython,
  Z as python
