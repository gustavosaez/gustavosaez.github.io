...
function r(n, e) {
  ...
  if (c = null, o) {
    ...
    if (i == "\\") return n.eol() || /\s/.test(n.peek()) ? (n.skipToEnd(), /^\\\s*$/.test(n.current()) ? (e.tokenize = k)(n) : e.tokenize = r, "comment") : (e.tokenize = r, "builtin");
  }
...
function m(n, e) {
  for (var o = false, i, t = false; i = n.next(); ) {
    if (i == '"' && !o) {
      t = true;
      break;
    }
...
const h = { name: "q", startState: function() {
  return { tokenize: r, context: null, indent: 0, col: 0 };
}, token: function(n, e) {
  n.sol() && (e.context && e.context.align == null && (e.context.align = false), e.indent = n.indentation());
  var o = e.tokenize(n, e);
  if (o != "comment" && e.context && e.context.align == null && e.context.type != "pattern" && (e.context.align = true), c == "(") l(e, ")", n.column());
  else if (c == "[") l(e, "]", n.column());
  else if (c == "{") l(e, "}", n.column());
  else if (/[\]\}\)]/.test(c)) {
    for (; e.context && e.context.type == "pattern"; ) u(e);
    e.context && c == e.context.type && u(e);
  } else c == "." && e.context && e.context.type == "pattern" ? u(e) : /atom|string|variable/.test(o) && e.context && (/[\}\]]/.test(e.context.type) ? l(e, "pattern", n.column()) : e.context.type == "pattern" && !e.context.align && (e.context.align = true, e.context.col = n.column()));
  return o;
