function f(e) {
  for (var n = {}, r = 0; r < e.length; ++r) n[e[r]] = true;
  return n;
}
...
function p(e, n) {
  ...
  if (/[a-zA-Z\.]/.test(r)) {
    e.eatWhile(/[\w\.]/);
    var i = e.current();
    return h.propertyIsEnumerable(i) ? "atom" : N.propertyIsEnumerable(i) ? (A.propertyIsEnumerable(i) && !e.match(/\s*if(\s+|$)/, false) && (t = "block"), "keyword") : m.propertyIsEnumerable(i) ? "builtin" : "variable";
...
const I = { name: "r", startState: function(e) {
  return { tokenize: p, ctx: { type: "top", indent: -e, flags: u }, indent: 0, afterIdent: false };
}, token: function(e, n) {
  ...
  return r != "comment" && (n.ctx.flags & u) == 0 && x(n, v), (t == ";" || t == "{" || t == "}") && n.ctx.type == "block" && a(n), t == "{" ? o(n, "}", e) : t == "(" ? (o(n, ")", e), n.afterIdent && (n.ctx.argList = true)) : t == "[" ? o(n, "]", e) : t == "block" ? o(n, "block", e) : t == n.ctx.type ? a(n) : n.ctx.type == "block" && r != "comment" && x(n, c), n.afterIdent = r == "variable" || r == "keyword", r;
