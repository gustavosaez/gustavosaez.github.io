function y(i) {
  i = { ...ae, ...i };
  var l = i.inline, m = i.tokenHooks, b = i.documentTypes || {}, G = i.mediaTypes || {}, J = i.mediaFeatures || {}, Q = i.mediaValueKeywords || {}, O = i.propertyKeywords || {}, F = i.nonStandardPropertyKeywords || {}, R = i.fontProperties || {}, ee = i.counterDescriptors || {}, N = i.colorKeywords || {}, V = i.valueKeywords || {}, g = i.allowNested, re = i.lineComment, oe = i.supportsAtComponent === true, W = i.highlightNonStandardPropertyKeywords !== false, w, n;
  function c(e, o) {
    return w = o, e;
  }
  function ie(e, o) {
    ...
    if (r === "-") {
      ...
      if (e.match(/^-[\w\\\-]*/)) return e.eatWhile(/[\w\\\-]/), e.match(/^\s*:/, false) ? c("def", "variable-definition") : c("variableName", "variable");
  ...
  function $(e) {
    return function(o, r) {
      for (var t = false, d; (d = o.next()) != null; ) {
        if (d == e && !t) {
          e == ")" && o.backUp(1);
          break;
        }
  ...
  function te(e, o) {
    return e.next(), e.match(/^\s*[\"\')]/, false) ? o.tokenize = null : o.tokenize = $(")"), c(null, "(");
  }
  function D(e, o, r) {
    this.type = e, this.indent = o, this.prev = r;
  }
  function s(e, o, r, t) {
    return e.context = new D(r, o.indentation() + (t === false ? 0 : o.indentUnit), e.context), r;
  }
  function u(e) {
  ...
  return a.top = function(e, o, r) {
    ...
    if (e == "word") {
      ...
      return O.hasOwnProperty(t) ? (n = "property", "maybeprop") : F.hasOwnProperty(t) ? (n = W ? "string.special" : "property", "maybeprop") : g ? (n = o.match(/^\s*:(?:\s|$)/, false) ? "property" : "tag", "block") : (n = "error", "maybeprop");
    ...
    return e == "}" ? h(e, o, r) : e == "{" ? u(r) && s(r, o, g ? "block" : "top", false) : (e == "word" && (n = "error"), r.context.type);
  ...
  }, { name: i.name, startState: function() {
...
const ce = y({ name: "scss", mediaTypes: v, mediaFeatures: x, mediaValueKeywords: B, propertyKeywords: z, nonStandardPropertyKeywords: K, colorKeywords: _, valueKeywords: j, fontProperties: P, allowNested: true, lineComment: "//", tokenHooks: { "/": function(i, l) {
  return i.eat("/") ? (i.skipToEnd(), ["comment", "comment"]) : i.eat("*") ? (l.tokenize = f, f(i, l)) : ["operator", "operator"];
}, ":": function(i) {
  return i.match(/^\s*\{/, false) ? [null, null] : false;
}, $: function(i) {
  return i.match(/^[\w-]+/), i.match(/^\s*:/, false) ? ["def", "variable-definition"] : ["variableName.special", "variable"];
}, "#": function(i) {
  return i.eat("{") ? [null, "interpolation"] : false;
} } }), de = y({ name: "less", mediaTypes: v, mediaFeatures: x, mediaValueKeywords: B, propertyKeywords: z, nonStandardPropertyKeywords: K, colorKeywords: _, valueKeywords: j, fontProperties: P, allowNested: true, lineComment: "//", tokenHooks: { "/": function(i, l) {
  return i.eat("/") ? (i.skipToEnd(), ["comment", "comment"]) : i.eat("*") ? (l.tokenize = f, f(i, l)) : ["operator", "operator"];
}, "@": function(i) {
  return i.eat("{") ? [null, "interpolation"] : i.match(/^(charset|document|font-face|import|(-(moz|ms|o|webkit)-)?keyframes|media|namespace|page|supports)\b/i, false) ? false : (i.eatWhile(/[\w\\\-]/), i.match(/^\s*:/, false) ? ["def", "variable-definition"] : ["variableName", "variable"]);
}, "&": function() {
  return ["atom", "atom"];
} } }), ue = y({ name: "gss", documentTypes: C, mediaTypes: v, mediaFeatures: x, propertyKeywords: z, nonStandardPropertyKeywords: K, fontProperties: P, counterDescriptors: I, colorKeywords: _, valueKeywords: j, supportsAtComponent: true, tokenHooks: { "/": function(i, l) {
  return i.eat("*") ? (l.tokenize = f, f(i, l)) : false;
} } });
export {
  se as css,
