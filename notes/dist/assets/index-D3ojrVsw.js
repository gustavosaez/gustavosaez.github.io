import { L as q, b as P, q as g, r as l, a as c, v as i, s as R, t as r, E as p } from "./index-CgUHbQAW.js";
const b = 1, $ = 33, m = 34, v = 35, x = 36, W = new p((O) => {
  let e = O.pos;
  for (; ; ) {
    if (O.next == 10) {
      O.advance();
...
}), top: "Attribute" }), E = { parser: U }, N = { parser: y }, s = g();
function S(O) {
...
function G(O = {}) {
  let e = s;
  if (O.base) {
    if (O.base.language.name != "html" || !(O.base.language instanceof q)) throw new RangeError("The base option must be the result of calling html(...)");
    e = O.base;
  }
  return new P(e.language == s.language ? k : S(e.language), [e.support, e.language.data.of({ closeBrackets: { brackets: ["[", "{", '"'] }, indentOnInput: /^\s*[\}\]]$/ })]);
}
export {
  G as angular,
