...
const g = { name: "cypher", startState: function() {
  ...
  if (t !== "comment" && e.context && e.context.align == null && e.context.type !== "pattern" && (e.context.align = true), i === "(") o(e, ")", n.column());
  else if (i === "[") o(e, "]", n.column());
  else if (i === "{") o(e, "}", n.column());
  else if (/[\]\}\)]/.test(i)) {
    for (; e.context && e.context.type === "pattern"; ) c(e);
    e.context && i === e.context.type && c(e);
  } else i === "." && e.context && e.context.type === "pattern" ? c(e) : /atom|string|variable/.test(t) && e.context && (/[\}\]]/.test(e.context.type) ? o(e, "pattern", n.column()) : e.context.type === "pattern" && !e.context.align && (e.context.align = true, e.context.col = n.column()));
  return t;
