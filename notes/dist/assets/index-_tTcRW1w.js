import { a as G, E as i, s as u, C as w, t as $, n as v, L as V, b, f as g, i as U, k as q, c as E } from "./index-CgUHbQAW.js";
const z = 154, X = 155, C = 156, N = 1, D = 2, f = 3, I = 157, F = 158, Z = 4, K = 5, L = 159, p = 160, W = 161, s = 162, T = 6, h = 7, A = 8, B = 9, c = 0, R = [9, 10, 11, 12, 13, 32, 133, 160, 5760, 8192, 8193, 8194, 8195, 8196, 8197, 8198, 8199, 8200, 8201, 8202, 8232, 8233, 8239, 8287, 12288], M = 58, J = 40, P = 95, H = 91, l = 45, OO = 46, m = 35, $O = 37, j = 123, eO = 125, o = 47, S = 42, r = 10, _ = 61, aO = 43, QO = 38;
function d(O) {
...
const tO = new i((O, e) => {
  if (e.dialectEnabled(c)) {
    let a;
    if (O.next < 0 && e.canShift(W)) O.acceptToken(W);
    else if (((a = O.peek(-1)) == r || a < 0) && e.canShift(p)) {
      let Q = 0;
      for (; O.next != r && R.includes(O.next); ) O.advance(), Q++;
      O.next == r || k(O) ? O.acceptToken(p, -Q) : Q && O.acceptToken(s);
    } else if (O.next == r) O.acceptToken(L, 1);
  ...
  if (k(O)) {
    if (O.advance(), e.dialectEnabled(c)) {
      ...
      if (a > -1) {
        let Q = O.next == S, t = 0;
        for (O.advance(); O.next >= 0; ) if (O.next == r) {
          O.advance();
          let n = 0;
  ...
  for (let a = false, Q = 0, t = 0; ; t++) {
    let { next: n } = O;
    if (d(n) || n == l || n == P || a && x(n)) !a && (n != l || t > 0) && (a = true), Q === t && n == l && Q++, O.advance();
  ...
  if (O.next == eO) {
    for (O.advance(); d(O.next) || O.next == l || O.next == P || x(O.next); ) O.advance();
