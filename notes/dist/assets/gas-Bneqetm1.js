function v(r) {
  ...
  function d(l, n) {
    for (var e = false, a; (a = l.next()) != null; ) {
      if (a === n && !e) return false;
      e = !e && a === "\\";
    }
    return e;
  }
  ...
  return { name: "gas", startState: function() {
