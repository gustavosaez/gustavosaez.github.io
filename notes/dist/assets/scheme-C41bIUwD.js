...
function w(e) {
  for (var n = {}, i = e.split(" "), t = 0; t < i.length; ++t) n[i[t]] = true;
  return n;
}
...
function u(e, n) {
  return n === true && e.backUp(1), e.match(R);
}
function O(e) {
  return e.match(I);
}
function y(e, n) {
  for (var i, t = false; (i = e.next()) != null; ) {
    if (i == n.token && !t) {
      n.state.mode = false;
      break;
    }
...
const U = { name: "scheme", startState: function() {
  ...
  switch (n.mode) {
    ...
    case "symbol":
      ...
      break;
    case "comment":
      for (var t, p = false; (t = e.next()) != null; ) {
        if (t == "#" && p) {
          n.mode = false;
          break;
        }
      ...
      break;
    case "s-expr-comment":
      if (n.mode = false, e.peek() == "(" || e.peek() == "[") n.sExprComment = 0;
      else {
        e.eatWhile(/[^\s\(\)\[\]]/), i = a;
        break;
      }
    default:
      ...
      else if (r == "'") e.peek() == "(" || e.peek() == "[" ? (typeof n.sExprQuote != "number" && (n.sExprQuote = 0), i = c) : (e.eatWhile(/[\w_\-!$%&*+\.\/:<=>?@\^~]/), i = c);
      else if (r == "|") n.mode = "symbol", i = x;
      else if (r == "#") if (e.eat("|")) n.mode = "comment", i = a;
      else if (e.eat(/[tf]/i)) i = c;
      else if (e.eat(";")) n.mode = "s-expr-comment", i = a;
      else {
        var l = null, o = false, m = true;
        e.eat(/[ei]/i) ? o = true : e.backUp(1), e.match(/^#b/i) ? l = B : e.match(/^#o/i) ? l = $ : e.match(/^#x/i) ? l = O : e.match(/^#d/i) ? l = u : e.match(/^[-+0-9.]/, false) ? (m = false, l = u) : o || e.eat("#"), l != null && (m && !o && e.match(/^#[ei]/i), l(e) && (i = b));
      }
      else if (/^[-+0-9.]/.test(r) && u(e, true)) i = b;
      ...
      } else r == ")" || r == "]" ? (i = v, n.indentStack != null && n.indentStack.type == (r == ")" ? "(" : "[") && (N(n), typeof n.sExprComment == "number" && --n.sExprComment == 0 && (i = a, n.sExprComment = false), typeof n.sExprQuote == "number" && --n.sExprQuote == 0 && (i = c, n.sExprQuote = false))) : (e.eatWhile(/[\w_\-!$%&*+\.\/:<=>?@\^~]/), k && k.propertyIsEnumerable(e.current()) ? i = E : i = "variable");
  }
