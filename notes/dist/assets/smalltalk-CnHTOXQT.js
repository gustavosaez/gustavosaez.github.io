var o = /[+\-\/\\*~<>=@%|&?!.,:;^]/, p = /true|false|nil|self|super|thisContext/, l = function(e, n) {
  ...
  this.context = new l(h, null), this.expectVariable = true, this.indentation = 0, this.userIndentationDelta = 0;
};
c.prototype.userIndent = function(e, n) {
  this.userIndentationDelta = e > 0 ? e / n - this.indentation : 0;
};
var h = function(e, n, t) {
  var i = new r(null, n, false), a = e.next();
  ...
  return e.eatWhile(/[^"]/), new r("comment", e.eat('"') ? n.parent : n, true);
}, s = function(e, n) {
  return e.eatWhile(/[^']/), new r("string", e.eat("'") ? n.parent : n, false);
}, f = function(e, n) {
  return e.eatWhile(/[^']/), new r("string.special", e.eat("'") ? n.parent : n, false);
}, x = function(e, n) {
  var t = new r(null, n, false), i = e.next();
  return i === "|" ? (t.context = n.parent, t.eos = true) : (e.eatWhile(/[^|]/), t.name = "variable"), t;
};
const d = { name: "smalltalk", startState: function() {
  return new c();
}, token: function(e, n) {
