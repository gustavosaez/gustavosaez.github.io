...
function m(t) {
  return function(n, e) {
    for (var i = false, a, o = false; (a = n.next()) != null; ) {
      if (a == t && !i) {
        o = true;
        break;
      }
...
const p = { name: "fortran", startState: function() {
